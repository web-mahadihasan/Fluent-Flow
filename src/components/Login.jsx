...
const Login = () => {
  ...
  return (
    <div data-aos="fade-left" className="px-4 py-8 z-10">
      <Helmet>
          <title>Fluent Flow | Log in</title>
      </Helmet>
      <h3 className="text-center my-10 uppercase text-2xl font-bold text-black/65">Log in to you account</h3>
        {
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        {/* Login button  */}
        <Button fullWidth type="submit" className="text-sm font-semibold tracking-wider bg-[#a38ffd]">Log in</Button>
      </form>
      ...
      <Button onClick={handleGoogleLogin}
        variant="outlined" className="flex w-full items-center border-gray-400 justify-center gap-2 text-sm font-semibold text-black/75">
