  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center justify-center">
      <div data-aos="fade-right" className="pl-6 xl:pl-10 py-6">
        ...
        Your Path to German Fluency Starts with
          <span className="text-[#a38ffd] uppercase inline-block mt-2 ml-3"> Fluent Flow</span>
        </h1>
        <p className="text-black/70 leading-7 my-6">
            Unlock the secrets of the German language with tailored lessons and engaging activities. Transform your dreams into reality—one word at a time
        </p>
